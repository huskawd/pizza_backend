...
class Container_7a83131b68 extends _PHPStan_b3f880679\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0474(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_7a83131b68 $container)
			{
	...
	public function createServiceContainer(): Container_7a83131b68
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHP_INI_SCAN_DIR' => '',
				'PHPRC' => '/tmp/9e0e32j1jm2a7cH1y9Q',
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/9e0e32j1jm2a7cH1y9Q|1|*|*|:/usr/local/etc/php/conf.d/docker-fpm.ini:/usr/local/etc/php/conf.d/docker-php-ext-bcmath.ini:/usr/local/etc/php/conf.d/docker-php-ext-intl.ini:/usr/local/etc/php/conf.d/docker-php-ext-opcache.ini:/usr/local/etc/php/conf.d/docker-php-ext-pdo_pgsql.ini:/usr/local/etc/php/conf.d/docker-php-ext-sodium.ini:/usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini:/usr/local/etc/php/conf.d/docker-php-ext-zip.ini:/usr/local/etc/php/conf.d/zz-app.ini|3.5.3',
			],
		];
	}
