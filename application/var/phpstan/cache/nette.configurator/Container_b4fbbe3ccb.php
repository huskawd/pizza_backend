...
class Container_b4fbbe3ccb extends _PHPStan_b3f880679\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0474(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_b4fbbe3ccb $container)
			{
	...
	public function createServiceContainer(): Container_b4fbbe3ccb
	{
		return $this;
	}
