...
class Container_781b5a168a extends _PHPStan_b3f880679\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0474(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_781b5a168a $container)
			{
	...
	public function createServiceContainer(): Container_781b5a168a
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHP_INI_SCAN_DIR' => '',
				'PHPRC' => '/tmp/emchs94gpvofcDUIM9a',
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/emchs94gpvofcDUIM9a|1|*|*|:/usr/local/etc/php/conf.d/docker-fpm.ini:/usr/local/etc/php/conf.d/docker-php-ext-bcmath.ini:/usr/local/etc/php/conf.d/docker-php-ext-intl.ini:/usr/local/etc/php/conf.d/docker-php-ext-opcache.ini:/usr/local/etc/php/conf.d/docker-php-ext-pdo_pgsql.ini:/usr/local/etc/php/conf.d/docker-php-ext-sodium.ini:/usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini:/usr/local/etc/php/conf.d/docker-php-ext-zip.ini:/usr/local/etc/php/conf.d/zz-app.ini|3.5.3',
			],
		];
	}
