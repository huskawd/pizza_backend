...
class Container_cbaaba5689 extends _PHPStan_b3f880679\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0474(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_cbaaba5689 $container)
			{
	...
	public function createServiceContainer(): Container_cbaaba5689
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHP_INI_SCAN_DIR' => '',
				'PHPRC' => '/tmp/7526ue6qjah9dr3kB8y',
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/7526ue6qjah9dr3kB8y|1|*|*|:/usr/local/etc/php/conf.d/docker-fpm.ini:/usr/local/etc/php/conf.d/docker-php-ext-bcmath.ini:/usr/local/etc/php/conf.d/docker-php-ext-intl.ini:/usr/local/etc/php/conf.d/docker-php-ext-opcache.ini:/usr/local/etc/php/conf.d/docker-php-ext-pdo_pgsql.ini:/usr/local/etc/php/conf.d/docker-php-ext-sodium.ini:/usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini:/usr/local/etc/php/conf.d/docker-php-ext-zip.ini:/usr/local/etc/php/conf.d/zz-app.ini|3.5.3',
			],
		];
	}
